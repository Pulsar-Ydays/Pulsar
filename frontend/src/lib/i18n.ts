...
const resources = {
  en: {
    translation: {
      ...
      term_and_condition:
        "© 2024 Pulsar. All rights reserved. Terms & ConditionsPrivacy Policy",
      ...
      sign_up: "SIGN UP",
      user: "User",
      empower_with_intelligent:
        "Empower with Intelligent Innovation. Tomorrow Unleashed: Intelligent Innovation Awaits.",
      ...
      what_is_the_total_value:
        "What is the total value of your crypto investments?",
      ...
      error: "Error",
      period: "Period",
      no_cryptocurrency_selected_or_data_not_available:
        "No cryptocurrency selected or data not available.",
  ...
  fr: {
    translation: {
      ...
      term_and_condition:
        "© 2024 Pulsar. Tous droits réservés. Conditions générales et politique de confidentialité",
      ...
      please_select:
        "Veuillez sélectionner une cryptomonnaie pour afficher son graphique",
      ...
      what_is_the_of_your_portfolio:
        "Quelle est la valeur de votre portefeuille ?",
      what_is_the_value_of_your_transfer:
      ...
      flat_tax: "Flat tax",
      loading_cryptocurrency_prices:
        "Chargement des cours des cryptomonnaies...",
      value: "Valeur:",
      towards: "Vers",
      ...
      no_cryptocurrency_data_available:
        "Aucune donnée de cryptomonnaie disponible",
